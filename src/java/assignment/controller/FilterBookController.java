 ...
 * @author Kaizer
 */
@WebServlet(name = "FilterBookController", urlPatterns = {"/FilterBookController"})
public class FilterBookController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookDTO> list = dao.getListBookByCategory(category);
            ...
            log("Error at FilterBookController: " + e.toString());
        } finally {
